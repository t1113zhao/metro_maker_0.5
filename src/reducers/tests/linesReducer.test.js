...
import reducer, {
    lineIDsGivenAgencyId,
    selectLinesGivenAgencyId,
    selectLineGivenID,
    selectAllLines
} from '../linesReducer'
...
describe('Lines Reducer', () => {
    ...
    it('should add single line to initial state correctly', () => {
        ...
        ).toEqual([{ id: 0, agencyID: 0, name: name, color: color, linetype: linetype, deletedAt: null }])
    })
    ...
    it('should select lines given id', () => {
        expect(selectLineGivenID(selectorstate, 0, true)).toEqual([{ id: 0, agencyID: 0, deletedAt: null }])
        expect(selectLineGivenID(selectorstate, 0, false)).toEqual([{ id: 0, agencyID: 0, deletedAt: null }])
        expect(selectLineGivenID(selectorstate, 2, true)).toEqual([{ id: 2, agencyID: 0, deletedAt: 'yesterday' }])
