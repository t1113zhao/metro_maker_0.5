...
describe('Transfer Reducer', () => {
    ...
    it('should add transfer correctly on empty state', () => {
        ...
        ).toEqual([{ id: 0, stationIDs: [stationA_ID, stationB_ID], type: type, deletedAt: null }])
    })
    ...
    it('should add transfer correctly on non empty state', () => {
        ...
        expect(
            reducer([{ id: 0, stationIDs: [0, 1], type: transferTypes.FREE_OUT_STATION, deletedAt: null }], {
                type: ADD_TRANSFER,
                payload: {
                    stationIDs: [stationA_ID, stationB_ID],
                    type: type
    ...
    it('should undo add transfer to non-empty state', () => {
        ...
        ).toEqual([{ id: 0, stationIDs: [0, 1], type: transferTypes.FREE_OUT_STATION, deletedAt: null }])
    })
    ...
    it('should edit transfer correctly', () => {
        ...
        ).toEqual([{ id: 0, stationIDs: [0, 1], type: newtype, deletedAt: null }])
    })
