...
describe('station action creator', () => {
    ...
    it('Getting Removable Transfers', () => {
        ...
        expect(transferIDsGivenStationID(store.getState().transfers, 0, true)).toEqual(
            [0, 1, 4]
        )
        ...
        expect(transferIDsGivenStationID(store.getState().transfers, 0, false)).toEqual(
            [1]
        )

        expect(transferIDsGivenStationID(store.getState().transfers, 1, false)).toEqual(
            [1, 2]
        )
    })
    ...
    it('should return correct inverse station actions', () => {
        ...
        expect(actions.getInverseStationActions(state.stations, {
            type: type.ADD_STATION,
            payload: {
                name: "Museum",
                description: "ROM",
        ...
        expect(store.dispatch(actions.getInverseStationActions(store.getState(), {
            type: type.REMOVE_STATION,
            payload: {
                id: 0,
                deletedAt: deletedAt,
